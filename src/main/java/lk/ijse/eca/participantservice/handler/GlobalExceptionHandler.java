package lk.ijse.eca.participantservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleParticipantNotFound(
    ...
    public ResponseEntity<ProblemDetail> handleDuplicateParticipant(
            DuplicateParticipantException ex, HttpServletRequest request) {
        log.warn("Duplicate participant: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT,
